...
with Client(
    ...
    app_version="@alonekingstar77 User Session",
    device_model="@alonekingstar77 Bot V3",
    system_version="@alonekingstar77 Pyro Server",
) as user:
    user.send_message(
        "me",
        ...
        "**Generated by @alonekingstar77 Manual Script.**",
    )
    print(
