...
Check all yt-dlp api options from this <a href='https://github.com/yt-dlp/yt-dlp/blob/master/yt_dlp/YoutubeDL.py#L212'>FILE</a> or use this <a href='http://t.me/ALONEKINGSTAR77/177'>script</a> to convert cli arguments to api options."""
...
Check all yt-dlp api options from this <a href='https://github.com/yt-dlp/yt-dlp/blob/master/yt_dlp/YoutubeDL.py#L184'>FILE</a> or use this <a href='http://t.me/ALONEKINGSTAR77/177'>script</a> to convert cli arguments to api options."""
...
def get_bot_commands():
    ...
    static_commands = {
        ...
        "Help": "Detailed help usage of the HemanthBot",
